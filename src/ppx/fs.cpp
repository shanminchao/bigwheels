...
{
#if defined(PPX_ANDROID)
    AAsset* temp_file = AAssetManager_open(gAndroidContext->activity->assetManager,
    ...
    AAssetDir *temp_dir = AAssetManager_openDir(gAndroidContext->activity->assetManager,
                                                path.c_str());
    if (temp_dir != nullptr) {
